...
CXXFLAGS_PYEXT = ['-pthread', '-fno-strict-aliasing', '-fwrapv', '-fstack-protector-strong', '-fno-strict-aliasing', '-fwrapv', '-fstack-protector-strong', '-fno-strict-aliasing', '-fvisibility=hidden', '-Wno-array-bounds']
...
NS3_MODULE_PATH = ['/usr/lib/gcc/x86_64-linux-gnu/4.9', '/home/zhangran/work/astra-sim/extern/network_backend/ns3/simulation/build']
